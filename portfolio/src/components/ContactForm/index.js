...
function ContactForm() {
  ...
  function sendEmail(e) {
      ...
      .then(function(response) {
        ...
        setFormMessage("Your message couldn't be sent. Please email Jake directly at w.jake.fullmer@gmail.com@gmail.com");
      });
  }
  ...
  return (
    <Form onSubmit={sendEmail} id="contactForm">
      ...
      <Form.Group controlId="email">
        ...
        <Form.Control required name="email" type="email" placeholder="jonhdoe@gmail.com"  onBlur={handleChange} />
      </Form.Group>
